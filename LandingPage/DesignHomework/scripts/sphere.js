...
function createWorld() {
  ...
  //---
  document.getElementById("morphing-sphere").appendChild(renderer.domElement);
  //---
...
function createLights() {
  ...
  let _backlight = new THREE.PointLight(Theme._white, 1);
  ...
  //---
  // _rectAreaLightHelper = new THREE.RectAreaLight(_rectAreaLight);
  //---
  let _frontlight = new THREE.PointLight(Theme._white, 2);
...
const skinElement = function (geo_frag = 5) {
  var geo_size = 20;
